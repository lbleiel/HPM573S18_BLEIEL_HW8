...
# When prob_head = 50%
trial1 = SetOfGames(prob_head=0.5, n_games=1000, id = 1)
test1 = trial1.simulation()
print("When the probability of heads is 50%:")
print('the expected reward is:', test1.get_ave_reward())
print("the 95% CI of expected reward is:", test1.get_CI_reward(0.05))
print('.')
# When prob_head = 45%
trial2 = SetOfGames(prob_head=0.45, n_games=1000, id = 1)
test2 = trial2.simulation()
print('When the probability of heads is 45%:')
print('the expected reward is', test2.get_ave_reward())
print("the 95% CI of expected reward is:", test2.get_CI_reward(0.05))
print('.')
# Calculating the change
print('In a steady-state scenario, the casino owner will see an increase in their reward of:')
print('$',test2.get_ave_reward()-test1.get_ave_reward())
print('This is a change of:', ((test2.get_ave_reward()-test1.get_ave_reward())/
      (-(test1.get_ave_reward())))*100,'%')
...
print('PROBLEM 2:')
# When prob_head = 50%
multipleGameSets=MultipleGameSets(ids=range(1000), prob_head=0.5, n_games_in_a_set=10)
multipleGameSets.simulation()
print('When the probability of heads is 50%:')
print('the projected mean reward is:',
      multipleGameSets.get_mean_total_reward())
# print projection interval
print('the 95% projection interval of average rewards is:',
      multipleGameSets.get_PI_total_reward(0.05))
print('.')
# When prob_head = 45%
multipleGameSets2=MultipleGameSets(ids=range(1000), prob_head=0.45, n_games_in_a_set=10)
multipleGameSets2.simulation()
print('When the probability of heads is 45%:')
print('the projected mean reward is:',
      multipleGameSets2.get_mean_total_reward())
# print projection interval
print('the 95% projection interval of average rewards is:',
      multipleGameSets2.get_PI_total_reward(0.05))
print('.')
# Calculating the change
print('In a steady-state scenario, the casino owner will see an increase in their reward of:')
print('$',multipleGameSets2.get_mean_total_reward()-multipleGameSets.get_mean_total_reward())
print('This is a change of:', ((multipleGameSets2.get_mean_total_reward()-multipleGameSets.get_mean_total_reward())/
      (-(multipleGameSets.get_mean_total_reward())))*100,'%')
